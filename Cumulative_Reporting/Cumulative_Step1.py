...
class QualCreate:
    ...
    def parse_commandline_args(self):
        ...
        parser = argparse.ArgumentParser(description="This Program will need 4 parameters to be passed by user \n 1. "
                                                     ...
                                                     "Date \n 4. Days")
        parser.add_argument('--epack', type=int, help="EPack Number", required=True)
        parser.add_argument('--starting_date', type=str, help="Starting Date", required=True)
        parser.add_argument('--ending_date', type=str, help="End Date", required=True)
        parser.add_argument('--days', type=int, help="Days", required=True)
